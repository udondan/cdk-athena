...
const logger = new StandardLogger(3); // TODO: remove the debug level
...
function Create(event: Event): Promise<Event> {
  ...
  return new Promise(function (resolve, reject) {
    ...
    logger.debug('Sending payload', JSON.stringify(params, null, 2));

    athena.createWorkGroup(params, function (
      err: AWS.AWSError,
      _: AWS.Athena.CreateWorkGroupOutput
    ) {
...
function getWorkGroup(name: string): Promise<AWS.Athena.GetWorkGroupOutput> {
  logger.info(`Fetching details of Athena WorkGroup ${name}`);
  return new Promise(function (resolve, reject) {
    var params = {
      WorkGroup: name,
    };
    ...
    athena.getWorkGroup(params, function (
      err: AWS.AWSError,
      data: AWS.Athena.GetWorkGroupOutput
    ) {
      if (err) return reject(err);
      resolve(data);
    });
...
function updateWorkGroup(event: Event): Promise<Event> {
  ...
  return new Promise(async function (resolve, reject) {
    ...
    logger.debug('Current WorkGroup', JSON.stringify(current, null, 2));
    ...
    athena.updateWorkGroup(params, function (
      err: AWS.AWSError,
      _: AWS.Athena.UpdateWorkGroupOutput
    ) {
      if (err) return reject(err);
      resolve(event);
    });
...
function updateWorkGroupAddTags(event: Event): Promise<Event> {
  ...
  return new Promise(function (resolve, reject) {
    ...
    athena.tagResource(params, function (
      err: AWS.AWSError,
      _: AWS.Athena.TagResourceOutput
    ) {
      if (err) return reject(err);
      resolve(event);
    });
...
function updateWorkGroupRemoveTags(event: Event): Promise<Event> {
  ...
  return new Promise(function (resolve, reject) {
    ...
    athena.untagResource(params, function (
      err: AWS.AWSError,
      _: AWS.Athena.UntagResourceOutput
    ) {
      if (err) return reject(err);
      resolve(event);
    });
...
function Delete(event: any): Promise<Event> {
  ...
  return new Promise(function (resolve, reject) {
    ...
    athena.deleteWorkGroup(params, function (
      err: AWS.AWSError,
      _: AWS.Athena.DeleteWorkGroupOutput
    ) {
      if (err) return reject(err);
      resolve(event);
    });
